                ...
                <li class="EatDealItem">
                    <a href="#">
                        <div class="EatDealItem__Picture">
                            <div class="EatDealItem__BGPicture"  style="display: block; background-image: url(./img/eat_deals/bucheon.jpeg);"></div>
                            ...
                            <div class="EatDealItem__PictureLeftArea">
                                ...
                                <div class="EatDealItem__DiscountValueLabel EatDealItem__PricePresentation EatDealItem__Badge">
                                    <span class="EatDealItem__DiscountValue EatDealItem__DiscountValue--Rate">10</span>
                                </div>
                            </div>
                            <div class="EatDealItem__PictureRightArea">
                                <div class="EatDealItem__PriceWrap">
                                    <span class="EatDealItem__OriginalPrice EatDealItem__PricePresentation">₩5,500</span>
                                    <span class="EatDealItem__SalesPrice EatDealItem__PricePresentation">₩4,950</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="EatDealItem__Content">
                            <div class="EatDealItem__LineWrap">
                                <span class="EatDealItem__RestaurantName">[부천] 피스앤스윗</span>
                            </div>
                            <p class="EatDealItem__Title">
                                <span class="ellip">
                                    <span style="white-space: nowrap;">흑임자크림라떼</span>
                                </span>
                            </p>
                        </div>
                    </a>

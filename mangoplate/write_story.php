            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <!-- 본문 추가 영역 -->
                        <h2>망고스토리 등록하기</h2>
                        <form method="post" action="write_story_ok.php" method="post">
                            <div class="story_titleArea">
                                <input type="text" class="story_title" name="ms_title" placeholder="제목을 입력하세요" autocomplete="off">
                                <input type="text" class="story_subtitle" name="ms_subtitle" placeholder="부제를 입력하세요" autocomplete="off">
                            </div>
                            <textarea name="ms_content" id="summernote"></textarea>

...
?>
    <div id="wrap">
        ...
        <div id="container">
            <div id="content">
                <form class="login_area" method="POST" action="./login_cookie_ok.php">
                    <div class="id_area">
    ...
    <div id="container">
        <div id="content">
            <div class="login_area">
                ...
                <input type="button" title="로그아웃" alt="로그아웃" value="로그아웃" class="btn" id="logout" onclick="location.href='./logout_cookie.php'">
            </div>
        </div>
    </div>

<?php
    ...
    $sql = "INSERT INTO min_board (b_userid, b_title, b_content, b_file) VALUES ('$id', '$b_title', '$b_content', '$filepath')";
    // echo $sql;
    $result = mysqli_query($conn, $sql);
    echo "<script>alert('작성되었습니다.'); location.href='list.php';</script>";
?>